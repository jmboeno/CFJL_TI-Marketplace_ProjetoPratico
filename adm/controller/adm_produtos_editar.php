...
if(isset($_POST['pro_apagar']) && isset($_POST['pro_id_apagar']) && $_POST['pro_apagar'] == 'SIM'){
	if($gravar->Apagar($_POST['pro_id_apagar'])){
        ...
        Rotas::Redirecionar(0, Rotas::pag_ProdutosADM());
	}else{
...
if(isset($_POST['pro_nome']) && isset($_POST['pro_valor'])){
    ...
    $pro_fornecedor      = $_POST['pro_fornecedor'];
    ...
    if(!empty($_FILES['pro_img']['name'])){
        ...
        $gravar->Preparar($pro_nome, $pro_fornecedor, $pro_categoria, $pro_ativo, $pro_modelo, $pro_ref, $pro_valor, $pro_estoque, $pro_peso, $pro_altura, $pro_largura, $pro_comprimento, $pro_img, $pro_desc, $pro_slug);
...
$smarty->assign('FORNECEDOR', $fornecedores->GetItens());
