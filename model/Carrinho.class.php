	...
	function GetCarrinho($sessao=NULL){
		...
		foreach ($_SESSION['PRO'] as $lista) {
			...
			$this->itens[$i] = array(
				...
				'pro_id' => $lista['ID'],
				'pro_fornecedor' => $lista['FORNECEDOR'],
				'pro_nome'  => $lista['NOME'],
		...
		switch ($ACAO) {
			case 'add':
					if(!isset($_SESSION['PRO'][$ID]['ID'])){
						...
						$_SESSION['PRO'][$ID]['FORNECEDOR'] = $FORNECEDOR;
					...
					echo '<h3 class="alerta pulse"> Produto Adicionado ao Carrinho! </h3>';
			...
			case 'del':
				$this->CarrinhoDEL($id);
				echo '<h3 class="alerta pulse"> Produto Removido! </h3>';
				echo '<div class="alerta" style="width: 250px;"> <img src="view/tema/images/produto_removido.gif" style="width: 100%;"> </div>';
				break;

			case 'limpar':
				$this->CarrinhoLimpar();
				echo '<h3 class="alerta pulse"> Todos os Produtos foram Removidos! </h3>';
				echo '<div class="alerta" style="width: 250px;"> <img src="view/tema/images/produto_removido.gif" style="width: 100%;"> </div>';
				break;
